...
class EventListPresenterInj @Inject constructor(currentTimeProvider: CurrentTimeProvider,
                                                ...
                                                eventsMapper: EventMapper, ioContextProvider: IoContextProvider)
    : EventListPresenter(currentTimeProvider,
        conferenceRepository, eventsMapper, ioContextProvider)

class EventDatePresenterInj @Inject constructor(repository: ConferenceRepository, ioContextProvider: IoContextProvider)
    : EventDatePresenter(repository, ioContextProvider)


class SpeakerListPresenterInj @Inject constructor(
        conferenceRepository: ConferenceRepository,
        speakersMapper: SpeakerMapper, ioContextProvider: IoContextProvider)
    : SpeakerListPresenter(conferenceRepository, speakersMapper, ioContextProvider)
...
class EventDetailPresenterInj @Inject constructor(
    ...
    : EventDetailPresenter(
        ...
        tokensStorage,
        speakerMapper,
        eventsMapper, authManager, ioContextProvider)


class FeedbackPresenterInj @Inject constructor(conferenceRepository: ConferenceRepository,
                                               ioContextProvider: IoContextProvider)
    : FeedbackPresenter(conferenceRepository, ioContextProvider)
...
class SpeakerDetailPresenterInj @Inject constructor(conferenceRepository: ConferenceRepository,
                                                    ...
                                                    ioContextProvider: IoContextProvider) : SpeakerDetailPresenter(conferenceRepository, speakerDetailMapper, ioContextProvider)


class InfoPresenterInj @Inject constructor(repository: LibrariesRepository,
                                           libraryMapper: LibraryMapper,
                                           webNavigator: WebNavigator,
                                           ioContextProvider: IoContextProvider) : InfoPresenter(repository,
        libraryMapper,
        webNavigator,
        ioContextProvider)
